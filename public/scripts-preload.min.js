...
$(document).ready((function(){if($(".qs_btn-dropdown").length>0){var e=$(".qs_btn-dropdown");$(e).each((function(e){$(this).find("._content").slideUp(0),$(this).click((function(){$(this).hasClass("_opened")?($(this).removeClass("_opened"),$(this).find("._content").slideUp(400)):($(this).addClass("_opened"),$(this).find("._content").slideDown(400))}))}))}}));const Modal=function(e,n){try{if("object"!=typeof e||!e.nodeName)throw new TypeError("First argument is not a DOM element. Expected: DOM element.");this.inside={},this.inside.root=e,this.inside.content=$(e).find("._content")[0],this.inside.btnOpen=[],$(e).find("._btn-close")[0]?this.inside.btnClose=[$(e).find("._btn-close")[0]]:this.inside.btnClose=[null],this.settings={},this.settings.animationTime=n||400,this.action={},this.action.open=()=>{this.inside.content&&$(this.inside.root).slideDown(this.settings.animationTime,()=>{this.inside.content&&$(this.inside.content).fadeIn(this.settings.animationTime),this.inside.btnClose[0]&&($(this.inside.btnClose[0]).fadeIn(this.settings.animationTime),this.inside.btnClose[0].focus())})},this.action.close=e=>{let n;n="force"===e?0:this.settings.animationTime,this.inside.btnClose[0]&&$(this.inside.btnClose[0]).fadeOut(n),this.inside.content&&$(this.inside.content).fadeOut(n,()=>{$(this.inside.root).slideUp(n)})},$(this.inside.btnClose).click(this.action.close),$(this.inside.btnClose).each((e,n)=>{$(n).click(this.action.close)}),$(this.inside.root).css({opacity:"1"}),this.action.close("force"),$(window).keyup(e=>{"Escape"===e.originalEvent.code&&this.action.close()}),this.addBtnOpen=e=>{if("object"==typeof e&&e instanceof Array)for(let n=0;n<e.length;n++){if("object"!=typeof e[n]||!e[n].nodeName){if(void 0===e[n])continue;throw new TypeError("Unexpected value of argument. Expected: DOM element or array of DOM elements")}this.inside.btnOpen.push(e[n])}else{if("object"!=typeof e||!e.nodeName){if(void 0===e)return!1;throw new TypeError("Unexpected value of argument. Expected: DOM element or array of DOM elements")}this.inside.btnOpen.push(e)}for(let e=0;e<this.inside.btnOpen.length;e++)console.log(this.inside.btnOpen[e]),$(this.inside.btnOpen[e]).click(this.action.open)}}catch(e){console.log(e)}};var qsModalArr=[];$(document).ready(()=>{$(".qs_modal").each((e,n)=>{qsModalArr.push({name:n,index:e,obj:new Modal(n)})});for(let e=0;e<qsModalArr.length;e++)switch(qsModalArr[e].name){case $(".header-menu")[0]:qsModalArr[e].obj.addBtnOpen($(".header__btn-nav-modal")[0]);break;case $(".header-callback")[0]:qsModalArr[e].obj.addBtnOpen($(".header__btn-callback")[0]),qsModalArr[e].obj.addBtnOpen($(".qs_consultation-and-next ._consultation")[0]);break;case $(".header-search")[0]:qsModalArr[e].obj.addBtnOpen($(".header__search")[0]);break;case $(".header-callback-vacancy")[0]:$(".carrier-list__vacancy").each((n,t)=>{qsModalArr[e].obj.addBtnOpen(t)})}});
function isMobile(){return!!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}$(document).ready((function(){var e=$(".qs_input");for(let n=0;n<e.length;n++)$(e[n]).find("input, textarea").on("focus",(function(){$(e[n]).find("input, textarea").addClass("_upper")})),$(e[n]).find("input, textarea").on("blur",(function(){""===$(e[n]).find("input, textarea").val()&&$(e[n]).find("input, textarea").removeClass("_upper")}))})),$(document).ready((function(){if($(".aside-nav").length>0){var e,n={init:!1,direction:"horizontal",loop:!1,spaceBetween:30,slidesPerView:"auto"},i=new Swiper(".aside-nav",n);function t(){window.innerWidth>850?"large"!==e&&(e="large",i.destroy(),_asudeNav=null):"small"!==e&&(e="small",(i=new Swiper(".aside-nav",n)).init())}i.init(),t(),$(window).resize(t)}}));
