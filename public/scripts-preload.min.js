...
function isMobile(){return!!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}function ModalWindows(n,e,t,o){var i={modal:void 0,content:void 0,btnOpen:[],btnClose:[],animationTime:void 0,open(){let n=this;n.content?$(n.modal).slideDown(n.animationTime,(function(){if($(n.content).fadeIn(n.animationTime),n.btnClose.length>0&&n.btnClose[0].focus(),n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeIn(n.animationTime)})):$(n.modal).slideDown(n.animationTime,(function(){if(n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeIn(n.animationTime)}))},close(){let n=this;if(n.content&&$(n.content).fadeOut(n.animationTime,(function(){$(n.modal).slideUp(n.animationTime)})),n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeOut(n.animationTime)}};if($(n).css({opacity:"1"}),i.modal=n,e&&"object"==typeof e)if(e.length){if(e.length>0)for(let n=0;n<e.length;n++)i.btnOpen.push(e[n])}else i.btnOpen.push(e);if(t&&"object"==typeof e)if(e.length){if(t.length>0)for(let n=0;n<t.length;n++)i.btnClose.push(t[n])}else i.btnClose.push(t);if($(i.modal).find("._btn-close")&&(i.btnClose.push($(i.modal).find("._btn-close")[0]),$($(i.modal).find("._btn-close")[0]).fadeOut(0)),$(i.modal).slideUp(0),i.btnOpen.length>0)for(let n=0;n<i.btnOpen.length;n++)$(i.btnOpen[n]).click((function(){i.open()}));if(i.btnClose.length>0)for(let n=0;n<i.btnClose.length;n++)$(i.btnClose[n]).click((function(){i.close()}));return $(i.modal).find("._content")&&(i.content=$(i.modal).find("._content")[0],$(i.content).fadeOut(0)),i.animationTime=o||350,i.open=function(){let n=this;n.content?$(n.modal).slideDown(n.animationTime,(function(){if($(n.content).fadeIn(n.animationTime),n.btnClose.length>0&&n.btnClose[0].focus(),n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeIn(n.animationTime)})):$(n.modal).slideDown(n.animationTime,(function(){if(n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeIn(n.animationTime)}))},i.close=function(){let n=this;if(n.content&&$(n.content).fadeOut(n.animationTime,(function(){$(n.modal).slideUp(n.animationTime)})),n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeOut(n.animationTime)},i}$(document).ready((function(){var n=$(".qs_input");for(let e=0;e<n.length;e++)$(n[e]).find("input, textarea").on("focus",(function(){$(n[e]).find("input, textarea").addClass("_upper")})),$(n[e]).find("input, textarea").on("blur",(function(){""===$(n[e]).find("input, textarea").val()&&$(n[e]).find("input, textarea").removeClass("_upper")}))})),$(document).ready((function(){if($(".aside-nav").length>0){var n,e={init:!1,direction:"horizontal",loop:!1,spaceBetween:30,slidesPerView:"auto"},t=new Swiper(".aside-nav",e);function o(){window.innerWidth>850?"large"!==n&&(n="large",t.destroy(),_asudeNav=null):"small"!==n&&(n="small",(t=new Swiper(".aside-nav",e)).init())}t.init(),o(),$(window).resize(o)}})),$(document).ready((function(){ModalWindows($(".header-callback")[0],$(".qs_consultation-and-next ._consultation"))}));
