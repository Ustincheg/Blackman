...
$(document).ready((function(){if($(".qs_btn-dropdown").length>0){var n=$(".qs_btn-dropdown");$(n).each((function(n){$(this).find("._content").slideUp(0),$(this).click((function(){$(this).hasClass("_opened")?($(this).removeClass("_opened"),$(this).find("._content").slideUp(400)):($(this).addClass("_opened"),$(this).find("._content").slideDown(400))}))}))}}));
function isMobile(){return!!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}function ModalWindows(n,e,t,o){var l={modal:void 0,content:void 0,btnOpen:[],btnClose:[],animationTime:void 0,open(){let n=this;n.content?$(n.modal).slideDown(n.animationTime,(function(){if($(n.content).fadeIn(n.animationTime),n.btnClose.length>0&&n.btnClose[0].focus(),n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeIn(n.animationTime)})):$(n.modal).slideDown(n.animationTime,(function(){if(n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeIn(n.animationTime)}))},close(){let n=this;if(n.content&&$(n.content).fadeOut(n.animationTime,(function(){$(n.modal).slideUp(n.animationTime)})),n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeOut(n.animationTime)}};if($(n).css({opacity:"1"}),l.modal=n,e&&"object"==typeof e)if(e.length){if(e.length>0)for(let n=0;n<e.length;n++)l.btnOpen.push(e[n])}else l.btnOpen.push(e);if(t&&"object"==typeof e)if(e.length){if(t.length>0)for(let n=0;n<t.length;n++)l.btnClose.push(t[n])}else l.btnClose.push(t);if($(l.modal).find("._btn-close")&&(l.btnClose.push($(l.modal).find("._btn-close")[0]),$($(l.modal).find("._btn-close")[0]).fadeOut(0)),$(l.modal).slideUp(0),l.btnOpen.length>0)for(let n=0;n<l.btnOpen.length;n++)$(l.btnOpen[n]).click((function(){l.open()}));if(l.btnClose.length>0)for(let n=0;n<l.btnClose.length;n++)$(l.btnClose[n]).click((function(){l.close()}));return $(l.modal).find("._content")&&(l.content=$(l.modal).find("._content")[0],$(l.content).fadeOut(0)),l.animationTime=o||350,l.open=function(){let n=this;n.content?$(n.modal).slideDown(n.animationTime,(function(){if($(n.content).fadeIn(n.animationTime),n.btnClose.length>0&&n.btnClose[0].focus(),n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeIn(n.animationTime)})):$(n.modal).slideDown(n.animationTime,(function(){if(n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeIn(n.animationTime)}))},l.close=function(){let n=this;if(n.content&&$(n.content).fadeOut(n.animationTime,(function(){$(n.modal).slideUp(n.animationTime)})),n.btnClose.length>0)for(let e=0;e<n.btnClose.length;e++)$(n.btnClose[e]).hasClass("_btn-close")&&$(n.btnClose[e]).fadeOut(n.animationTime)},l}$(document).ready((function(){var n=$(".qs_input");for(let e=0;e<n.length;e++)$(n[e]).find("input, textarea").on("focus",(function(){$(n[e]).find("input, textarea").addClass("_upper")})),$(n[e]).find("input, textarea").on("blur",(function(){""===$(n[e]).find("input, textarea").val()&&$(n[e]).find("input, textarea").removeClass("_upper")}))})),$(document).ready((function(){if($(".aside-nav").length>0){var n,e={init:!1,direction:"horizontal",loop:!1,spaceBetween:30,slidesPerView:"auto"},t=new Swiper(".aside-nav",e);function o(){window.innerWidth>850?"large"!==n&&(n="large",t.destroy(),_asudeNav=null):"small"!==n&&(n="small",(t=new Swiper(".aside-nav",e)).init())}t.init(),o(),$(window).resize(o)}})),$(document).ready((function(){ModalWindows($(".header-callback")[0],$(".qs_consultation-and-next ._consultation"))})),$(document).ready((function(){if(!$(".body").hasClass("page-home")&&$(".aside").length>0){var n=$('.aside-nav-list__link[href^="#"]'),e=$(".main section[id]"),t=$(".main");o={anchorArr:[],contentArr:[],scroll:void 0},n.each(e=>o.anchorArr.push({elem:n[e],value:$(n[e]).attr("href").replace(/#/,"")})),e.each(n=>o.contentArr.push({elem:e[n],value:$(e[n]).attr("id"),top:e[n].getBoundingClientRect().y-$(t).offset().top,bottom:$(e[n]).offset().top+$(e[n]).height()})),o.currentValue=n=>{for(let e=0;e<o.contentArr.length;e++)if(n>=o.contentArr[e].top&&n<=o.contentArr[e].bottom)for(let n=0;n<o.anchorArr.length;n++)o.anchorArr[n].value===o.contentArr[e].value&&$(o.anchorArr[n].elem).addClass("_current");else for(let n=0;n<o.anchorArr.length;n++)o.anchorArr[n].value===o.contentArr[e].value&&$(o.anchorArr[n].elem).removeClass("_current")},t.on("scroll",n=>{o.currentValue(t.scrollTop()),o.scroll=t.scrollTop(),console.log(t.scrollTop()),console.log(o.contentArr[1].top)})}var o}));
