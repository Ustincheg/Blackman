...
<<<<<<< HEAD
$(document).ready((function(){if($(".qs_btn-dropdown").length>0){var e=$(".qs_btn-dropdown");$(e).each((function(){$(this).find("._content").slideUp(0),$(this).click((function(){$(this).hasClass("_opened")?($(this).removeClass("_opened"),$(this).find("._content").slideUp(400)):($(this).addClass("_opened"),$(this).find("._content").slideDown(400))}))}))}}));const Modal=function(e,t){try{if("object"!=typeof e||!e.nodeName)throw new TypeError("First argument is not a DOM element. Expected: DOM element.");this.inside={},this.inside.root=e,this.inside.content=$(e).find("._content")[0],this.inside.btnOpen=[],$(e).find("._btn-close")[0]?this.inside.btnClose=[$(e).find("._btn-close")[0]]:this.inside.btnClose=[null],this.settings={},this.settings.animationTime=t||400,this.action={},this.action.open=()=>{this.inside.content&&$(this.inside.root).slideDown(this.settings.animationTime,()=>{this.inside.content&&$(this.inside.content).fadeIn(this.settings.animationTime),this.inside.btnClose[0]&&($(this.inside.btnClose[0]).fadeIn(this.settings.animationTime),this.inside.btnClose[0].focus())})},this.action.close=e=>{let t;t="force"===e?0:this.settings.animationTime,this.inside.btnClose[0]&&$(this.inside.btnClose[0]).fadeOut(t),this.inside.content&&$(this.inside.content).fadeOut(t,()=>{$(this.inside.root).slideUp(t)})},$(this.inside.btnClose).click(this.action.close),$(this.inside.btnClose).each((e,t)=>{$(t).click(this.action.close)}),$(this.inside.root).css({opacity:"1"}),this.action.close("force"),$(window).keyup(e=>{"Escape"===e.originalEvent.code&&this.action.close()}),this.addBtnOpen=e=>{if("object"==typeof e&&e instanceof Array)for(let t=0;t<e.length;t++){if("object"!=typeof e[t]||!e[t].nodeName){if(void 0===e[t])continue;throw new TypeError("Unexpected type of argument. Expected: DOM element or array of DOM elements")}this.inside.btnOpen.push(e[t])}else{if("object"!=typeof e||!e.nodeName){if(void 0===e)return!1;throw new TypeError("Unexpected type of argument. Expected: DOM element or array of DOM elements")}this.inside.btnOpen.push(e)}for(let e=0;e<this.inside.btnOpen.length;e++)$(this.inside.btnOpen[e]).click(this.action.open)}}catch(e){console.log(e)}};var qsModalArr=[];$(document).ready(()=>{$(".qs_modal").each((e,t)=>{qsModalArr.push({elem:t,index:e,obj:new Modal(t)})});for(let e=0;e<qsModalArr.length;e++)switch(qsModalArr[e].elem){case $(".header-menu")[0]:qsModalArr[e].obj.addBtnOpen($(".header__btn-nav-modal")[0]);break;case $(".header-callback")[0]:qsModalArr[e].obj.addBtnOpen($(".header__btn-callback")[0]),qsModalArr[e].obj.addBtnOpen($(".qs_consultation-and-next ._consultation")[0]);break;case $(".header-search")[0]:qsModalArr[e].obj.addBtnOpen($(".header__search")[0]);break;case $(".header-callback-vacancy")[0]:$(".carrier-list__vacancy").each((t,n)=>{qsModalArr[e].obj.addBtnOpen(n)})}});
const FormValidation=function(e,t){try{if("object"!=typeof e&&!e.nodeName)throw new TypeError("Argument is not a DOM element. Expected: DOM element.");let i=new Event("form-status-correct"),n=new Event("form-status-incorrect");if(this.inside={},this.inside.form=e,this.inside.ignor=[],this.inside.inputText={},this.inside.inputText.elems=[],this.inside.inputText.valueCheckAlgorithm=void 0,this.inside.inputText.valueLength=void 0,this.inside.inputTel={},this.inside.inputTel.elems=[],this.inside.inputTel.valueCheckAlgorithm=void 0,this.inside.inputTel.valueLength=void 0,this.inside.inputEmail={},this.inside.inputEmail.elems=[],this.inside.inputEmail.valueCheckAlgorithm=void 0,this.inside.inputEmail.valueLength=void 0,this.inside.textarea={},this.inside.textarea.elems=[],this.inside.textarea.valueCheckAlgorithm=void 0,this.inside.textarea.valueLength=void 0,this.inside.acceptance={},this.inside.acceptance.elems=[],this.inside.submit={},this.inside.submit.elems=[],this.options={},this.options.inputText={valueCheckAlgorithm:e=>{if(!(e instanceof RegExp))throw new TypeError('Second argument, "inputText.valueCheckAlgorithm" is not a regular expression. Expected: nothing or regular expression.');this.inside.inputText.valueCheckAlgorithm=e},valueLength:e=>{if("number"!=typeof e)throw new TypeError('Second argument, "inputText.valueLength" is not a number. Expected: nothing or number.');this.inside.inputText.valueLength=e}},this.options.inputTel={valueCheckAlgorithm:e=>{if(!(e instanceof RegExp))throw new TypeError('Second argument, "inputTel.valueCheckAlgorithm" is not a regular expression. Expected: nothing or regular expression.');this.inside.inputTel.valueCheckAlgorithm=e},valueLength:e=>{if("number"!=typeof e)throw new TypeError('Second argument, "inputTel.valueLength" is not a number. Expected: nothing or number.');this.inside.inputTel.valueLength=e}},this.options.inputEmail={valueCheckAlgorithm:e=>{if(!(e instanceof RegExp))throw new TypeError('Second argument, "inputText.valueCheckAlgorithm" is not a regular expression. Expected: nothing or regular expression.');this.inside.inputEmail.valueCheckAlgorithm=e},valueLength:e=>{if("number"!=typeof e)throw new TypeError('Second argument, "inputEmail.valueLength" is not a number. Expected: nothing or number.');this.inside.inputEmail.valueLength=e}},this.options.textarea={valueCheckAlgorithm:e=>{if(!(e instanceof RegExp))throw new TypeError('Second argument, "textarea.valueCheckAlgorithm" is not a regular expression. Expected: nothing or regular expression.');this.inside.textarea.valueCheckAlgorithm=e},valueLength:e=>{if("number"!=typeof e)throw new TypeError('Second argument, "textarea.valueLength" is not a number. Expected: nothing or number.');this.inside.textarea.valueLength=e}},this.options.acceptance=e=>{if("object"!=typeof e)throw new TypeError('Second argument, "acceptance" is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');if(e instanceof Array)e.forEach(e=>{if(!e.nodeName)throw new TypeError('Second argument, element from "acceptance" array is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');this.inside.acceptance.elems.push(e)});else{if(!e.nodeName)throw new TypeError('Second argument, "acceptance" is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');this.inside.acceptance.elems.push(e)}},this.options.ignor=e=>{if("object"!=typeof e)throw new TypeError('Second argument, "ignor" is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');if(e instanceof Array)e.forEach(e=>{if(!e.nodeName)throw new TypeError('Second argument, element from "ignor" array is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');this.inside.ignor.push(e)});else{if(!e.nodeName)throw new TypeError('Second argument, "ignor" is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');this.inside.ignor.push(e)}},"object"==typeof t)for(_property in t)switch(_property){case"inputText":"valueCheckAlgorithm"in t.inputText&&this.options.inputText.valueCheckAlgorithm(t.inputText.valueCheckAlgorithm),"valueLength"in t.inputText&&(this.options.inputText.valueLength(t.inputText.valueLength),this.inside.inputText.elems.forEach(e=>{$(e).attr({maxlength:t.inputText.valueLength})}));break;case"inputTel":"valueCheckAlgorithm"in t.inputTel&&this.options.inputTel.valueCheckAlgorithm(t.inputTel.valueCheckAlgorithm),"valueLength"in t.inputTel&&(this.options.inputTel.valueLength(t.inputTel.valueLength),this.inside.inputTel.elems.forEach(e=>{$(e).attr({maxlength:t.inputTel.valueLength})}));break;case"inputEmail":"valueCheckAlgorithm"in t.inputEmail&&this.options.inputEmail.valueCheckAlgorithm(t.inputEmail.valueCheckAlgorithm),"valueLength"in t.inputEmail&&(this.options.inputEmail.valueLength(t.inputEmail.valueLength),this.inside.inputEmail.elems.forEach(e=>{$(e).attr({maxlength:t.inputEmail.valueLength})}));break;case"textarea":"valueCheckAlgorithm"in t.textarea&&this.options.textarea.valueCheckAlgorithm(t.textarea.valueCheckAlgorithm),"valueLength"in t.textarea&&(this.options.textarea.valueLength(t.textarea.valueLength),this.inside.textarea.elems.forEach(e=>{$(e).attr({maxlength:t.textarea.valueLength})}));break;case"acceptance":this.options.acceptance(t.acceptance);break;case"ignor":this.options.ignor(t.ignor)}$(e).find('input[type="text"]').each((e,t)=>{this.inside.ignor.length>0?this.inside.ignor.forEach(e=>{e!==t&&this.inside.inputText.elems.push(t)}):this.inside.inputText.elems.push(t)}),$(e).find('input[type="tel"]').each((e,t)=>{this.inside.ignor.length>0?this.inside.ignor.forEach(e=>{e!==t&&this.inside.inputTel.elems.push(t)}):this.inside.inputTel.elems.push(t)}),$(e).find('input[type="email"]').each((e,t)=>{this.inside.ignor.length>0?this.inside.ignor.forEach(e=>{e!==t&&this.inside.inputEmail.elems.push(t)}):this.inside.inputEmail.elems.push(t)}),$(e).find("textarea").each((e,t)=>{this.inside.ignor.length>0?this.inside.ignor.forEach(e=>{e!==t&&this.inside.textarea.elems.push(t)}):this.inside.textarea.elems.push(t)}),$(e).find('input[type="submit"]').each((e,t)=>{this.inside.submit.elems.push(t)}),$(e).find('button[type="submit"]').each((e,t)=>{this.inside.submit.elems.push(t)}),this.inside.submit.elems.forEach(e=>{$(e).click(e=>{e.preventDefault(),this.check()})}),this._elemStatus=[],this.testMode=!1,this.check=()=>{function e(e){if(!(e.elems.length>0))return!0;for(let t=0;t<e.elems.length;t++){let i=e.elems[t];if($(i).attr("required")){if(""===i.value){_this._elemStatus.push({elem:i,status:"incorrect"}),$(i).addClass("_incorrect");continue}}else if(""===i.value){_this._elemStatus.push({elem:i,status:"correct"}),$(i).removeClass("_incorrect");continue}if(null!=e.valueLength){if(!(i.value.length<=e.valueLength)){_this._elemStatus.push({elem:i,status:"incorrect"}),$(i).addClass("_incorrect");continue}_this._elemStatus.push({elem:i,status:"correct"})}i.checkValidity()?e.valueCheckAlgorithm?e.valueCheckAlgorithm.test(i.value)?(_this._elemStatus.push({elem:i,status:"correct"}),$(i).removeClass("_incorrect")):(_this._elemStatus.push({elem:i,status:"incorrect"}),$(i).addClass("_incorrect")):(_this._elemStatus.push({elem:i,status:"correct"}),$(i).removeClass("_incorrect")):(_this._elemStatus.push({elem:i,status:"incorrect"}),$(i).addClass("_incorrect"))}}this._elemStatus.length=0,_this=this,e(this.inside.inputText),e(this.inside.inputTel),e(this.inside.inputEmail),e(this.inside.textarea),this.inside.acceptance.elems.length>0&&this.inside.acceptance.elems.forEach(e=>{$(e).is(":checked")?this._elemStatus.push({elem:e,status:"correct"}):this._elemStatus.push({elem:e,status:"incorrect"})});for(let e=0;e<this._elemStatus.length;e++){if("incorrect"===this._elemStatus[e].status){this.testMode&&($(this.inside.form).removeClass("test_STATUS-CORRECT"),$(this.inside.form).addClass("test_STATUS-INCORRECT")),this.inside.form.dispatchEvent(n);break}e+1===this._elemStatus.length&&(this.testMode?($(this.inside.form).removeClass("test_STATUS-INCORRECT"),$(this.inside.form).addClass("test_STATUS-CORRECT")):this.inside.form.dispatchEvent(i))}},Object.defineProperty(this,"_elemStatus",{writable:!1,configurable:!1})}catch(e){console.log(e)}};$(document).ready(()=>{if($(".header-callback .header-callback-form").length>0)new FormValidation($(".header-callback .header-callback-form")[0],{inputText:{valueLength:254},inputTel:{valueCheckAlgorithm:/^(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)?$/,valueLength:50},inputEmail:{valueCheckAlgorithm:/^([a-z0-9_-]+\.)*[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/,valueLength:254}});if($(".header-callback-vacancy .header-callback-form").length>0)new FormValidation($(".header-callback-vacancy .header-callback-form")[0],{inputText:{valueLength:254},inputTel:{valueCheckAlgorithm:/^(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)?$/,valueLength:50},inputEmail:{valueCheckAlgorithm:/^([a-z0-9_-]+\.)*[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/,valueLength:254},ignor:$(".header-callback__vacancy")[0]})});
function isMobile(){return!!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}$(document).ready((function(){var e=$(".qs_input");for(let t=0;t<e.length;t++)$(e[t]).find("input, textarea").on("focus",(function(){$(e[t]).find("input, textarea").addClass("_upper")})),$(e[t]).find("input, textarea").on("blur",(function(){""===$(e[t]).find("input, textarea").val()&&$(e[t]).find("input, textarea").removeClass("_upper")}))})),$(document).ready((function(){if($(".aside-nav").length>0){var e,t={init:!1,direction:"horizontal",loop:!1,spaceBetween:30,slidesPerView:"auto"},n=new Swiper(".aside-nav",t);function i(){window.innerWidth>850?"large"!==e&&(e="large",n.destroy(),_asudeNav=null):"small"!==e&&(e="small",(n=new Swiper(".aside-nav",t)).init())}n.init(),i(),$(window).resize(i)}})),$(document).ready((function(){const e=document.querySelectorAll('a[href^="#"].aside-nav-list__link');for(let t of e)t.addEventListener("click",(function(e){e.preventDefault();const n=t.getAttribute("href");document.querySelector('a[href^="#"].aside-nav-list__link._current').classList.remove("_current"),t.classList.add("_current"),document.querySelector(n).scrollIntoView({behavior:"smooth",block:"start"})}));if(!$("body").hasClass("page-home")&&$(".aside").length>0){var t=$('.aside-nav-list__link[href^="#"]'),n=$(".main"),i=$(".content-wrapper"),r=[];function a(e){r.forEach(t=>{t.value===e?$(t.elem).addClass("_current"):$(t.elem).removeClass("_current")})}t.each((e,t)=>r.push({elem:t,value:$(t).attr("href").replace(/#/,"")})),$(t[0]).addClass("_current"),n.on("scroll",(function(){let e=i[0].offsetWidth-i[0].clientWidth,t=document.elementFromPoint(window.screen.width-(e+101),window.screen.height/2);$("body").hasClass("page-projects")?$(t).is("li[id]")?a($(t).attr("id")):$(t).parents("li[id]").length>0&&a($(t).parents("li[id]").attr("id")):$(t).is("section[id]")?a($(t).attr("id")):$(t).parents("section[id]").length>0&&a($(t).parents("section[id]").attr("id"))}))}}));
=======
$(document).ready((function(){if($(".qs_btn-dropdown").length>0){var e=$(".qs_btn-dropdown");$(e).each((function(){$(this).find("._content").slideUp(0),$(this).click((function(){$(this).hasClass("_opened")?($(this).removeClass("_opened"),$(this).find("._content").slideUp(400)):($(this).addClass("_opened"),$(this).find("._content").slideDown(400))}))}))}}));const Modal=function(e,t){try{if("object"!=typeof e||!e.nodeName)throw new TypeError("First argument is not a DOM element. Expected: DOM element.");this.inside={},this.inside.root=e,this.inside.content=$(e).find("._content")[0],this.inside.btnOpen=[],$(e).find("._btn-close")[0]?this.inside.btnClose=[$(e).find("._btn-close")[0]]:this.inside.btnClose=[null],this.settings={},this.settings.animationTime=t||400,this.action={},this.action.open=()=>{this.inside.content&&$(this.inside.root).slideDown(this.settings.animationTime,()=>{this.inside.content&&$(this.inside.content).fadeIn(this.settings.animationTime),this.inside.btnClose[0]&&($(this.inside.btnClose[0]).fadeIn(this.settings.animationTime),this.inside.btnClose[0].focus())})},this.action.close=e=>{let t;t="force"===e?0:this.settings.animationTime,this.inside.btnClose[0]&&$(this.inside.btnClose[0]).fadeOut(t),this.inside.content&&$(this.inside.content).fadeOut(t,()=>{$(this.inside.root).slideUp(t)})},$(this.inside.btnClose).click(this.action.close),$(this.inside.btnClose).each((e,t)=>{$(t).click(this.action.close)}),$(this.inside.root).css({opacity:"1"}),this.action.close("force"),$(window).keyup(e=>{"Escape"===e.originalEvent.code&&this.action.close()}),this.addBtnOpen=e=>{if("object"==typeof e&&e instanceof Array)for(let t=0;t<e.length;t++){if("object"!=typeof e[t]||!e[t].nodeName){if(void 0===e[t])continue;throw new TypeError("Unexpected type of argument. Expected: DOM element or array of DOM elements")}this.inside.btnOpen.push(e[t])}else{if("object"!=typeof e||!e.nodeName){if(void 0===e)return!1;throw new TypeError("Unexpected type of argument. Expected: DOM element or array of DOM elements")}this.inside.btnOpen.push(e)}for(let e=0;e<this.inside.btnOpen.length;e++)$(this.inside.btnOpen[e]).click(this.action.open)}}catch(e){console.log(e)}};var qsModalArr=[];$(document).ready(()=>{$(".qs_modal").each((e,t)=>{qsModalArr.push({elem:t,index:e,obj:new Modal(t)})});for(let e=0;e<qsModalArr.length;e++)switch(qsModalArr[e].elem){case $(".header-menu")[0]:qsModalArr[e].obj.addBtnOpen($(".header__btn-nav-modal")[0]);break;case $(".header-callback")[0]:qsModalArr[e].obj.addBtnOpen($(".header__btn-callback")[0]),qsModalArr[e].obj.addBtnOpen($(".qs_consultation-and-next ._consultation")[0]);break;case $(".header-search")[0]:qsModalArr[e].obj.addBtnOpen($(".header__search")[0]);break;case $(".header-callback-vacancy")[0]:$(".carrier-list__vacancy").each((t,n)=>{qsModalArr[e].obj.addBtnOpen(n)})}}),$(document).ready((function(){var e=$(".qs_input");for(let t=0;t<e.length;t++)$(e[t]).find("input, textarea").on("focus",(function(){$(e[t]).find("input, textarea").addClass("_upper")})),$(e[t]).find("input, textarea").on("blur",(function(){""===$(e[t]).find("input, textarea").val()&&$(e[t]).find("input, textarea").removeClass("_upper")}))}));
const FormValidation=function(e,t){try{if("object"!=typeof e&&!e.nodeName)throw new TypeError("Argument is not a DOM element. Expected: DOM element.");let i=new Event("form-status-correct"),n=new Event("form-status-incorrect");if(this.inside={},this.inside.form=e,this.inside.ignor=[],this.inside.inputText={},this.inside.inputText.elems=[],this.inside.inputText.valueCheckAlgorithm=void 0,this.inside.inputText.valueLength=void 0,this.inside.inputTel={},this.inside.inputTel.elems=[],this.inside.inputTel.valueCheckAlgorithm=void 0,this.inside.inputTel.valueLength=void 0,this.inside.inputEmail={},this.inside.inputEmail.elems=[],this.inside.inputEmail.valueCheckAlgorithm=void 0,this.inside.inputEmail.valueLength=void 0,this.inside.textarea={},this.inside.textarea.elems=[],this.inside.textarea.valueCheckAlgorithm=void 0,this.inside.textarea.valueLength=void 0,this.inside.acceptance={},this.inside.acceptance.elems=[],this.inside.submit={},this.inside.submit.elems=[],this.options={},this.options.inputText={valueCheckAlgorithm:e=>{if(!(e instanceof RegExp))throw new TypeError('Second argument, "inputText.valueCheckAlgorithm" is not a regular expression. Expected: nothing or regular expression.');this.inside.inputText.valueCheckAlgorithm=e},valueLength:e=>{if("number"!=typeof e)throw new TypeError('Second argument, "inputText.valueLength" is not a number. Expected: nothing or number.');this.inside.inputText.valueLength=e}},this.options.inputTel={valueCheckAlgorithm:e=>{if(!(e instanceof RegExp))throw new TypeError('Second argument, "inputTel.valueCheckAlgorithm" is not a regular expression. Expected: nothing or regular expression.');this.inside.inputTel.valueCheckAlgorithm=e},valueLength:e=>{if("number"!=typeof e)throw new TypeError('Second argument, "inputTel.valueLength" is not a number. Expected: nothing or number.');this.inside.inputTel.valueLength=e}},this.options.inputEmail={valueCheckAlgorithm:e=>{if(!(e instanceof RegExp))throw new TypeError('Second argument, "inputText.valueCheckAlgorithm" is not a regular expression. Expected: nothing or regular expression.');this.inside.inputEmail.valueCheckAlgorithm=e},valueLength:e=>{if("number"!=typeof e)throw new TypeError('Second argument, "inputEmail.valueLength" is not a number. Expected: nothing or number.');this.inside.inputEmail.valueLength=e}},this.options.textarea={valueCheckAlgorithm:e=>{if(!(e instanceof RegExp))throw new TypeError('Second argument, "textarea.valueCheckAlgorithm" is not a regular expression. Expected: nothing or regular expression.');this.inside.textarea.valueCheckAlgorithm=e},valueLength:e=>{if("number"!=typeof e)throw new TypeError('Second argument, "textarea.valueLength" is not a number. Expected: nothing or number.');this.inside.textarea.valueLength=e}},this.options.acceptance=e=>{if("object"!=typeof e)throw new TypeError('Second argument, "acceptance" is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');if(e instanceof Array)e.forEach(e=>{if(!e.nodeName)throw new TypeError('Second argument, element from "acceptance" array is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');this.inside.acceptance.elems.push(e)});else{if(!e.nodeName)throw new TypeError('Second argument, "acceptance" is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');this.inside.acceptance.elems.push(e)}},this.options.ignor=e=>{if("object"!=typeof e)throw new TypeError('Second argument, "ignor" is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');if(e instanceof Array)e.forEach(e=>{if(!e.nodeName)throw new TypeError('Second argument, element from "ignor" array is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');this.inside.ignor.push(e)});else{if(!e.nodeName)throw new TypeError('Second argument, "ignor" is not a DOM element. Expected: nothing, DOM element or array of DOM elements.');this.inside.ignor.push(e)}},"object"==typeof t)for(_property in t)switch(_property){case"inputText":"valueCheckAlgorithm"in t.inputText&&this.options.inputText.valueCheckAlgorithm(t.inputText.valueCheckAlgorithm),"valueLength"in t.inputText&&(this.options.inputText.valueLength(t.inputText.valueLength),this.inside.inputText.elems.forEach(e=>{$(e).attr({maxlength:t.inputText.valueLength})}));break;case"inputTel":"valueCheckAlgorithm"in t.inputTel&&this.options.inputTel.valueCheckAlgorithm(t.inputTel.valueCheckAlgorithm),"valueLength"in t.inputTel&&(this.options.inputTel.valueLength(t.inputTel.valueLength),this.inside.inputTel.elems.forEach(e=>{$(e).attr({maxlength:t.inputTel.valueLength})}));break;case"inputEmail":"valueCheckAlgorithm"in t.inputEmail&&this.options.inputEmail.valueCheckAlgorithm(t.inputEmail.valueCheckAlgorithm),"valueLength"in t.inputEmail&&(this.options.inputEmail.valueLength(t.inputEmail.valueLength),this.inside.inputEmail.elems.forEach(e=>{$(e).attr({maxlength:t.inputEmail.valueLength})}));break;case"textarea":"valueCheckAlgorithm"in t.textarea&&this.options.textarea.valueCheckAlgorithm(t.textarea.valueCheckAlgorithm),"valueLength"in t.textarea&&(this.options.textarea.valueLength(t.textarea.valueLength),this.inside.textarea.elems.forEach(e=>{$(e).attr({maxlength:t.textarea.valueLength})}));break;case"acceptance":this.options.acceptance(t.acceptance);break;case"ignor":this.options.ignor(t.ignor)}$(e).find('input[type="text"]').each((e,t)=>{this.inside.ignor.length>0?this.inside.ignor.forEach(e=>{e!==t&&this.inside.inputText.elems.push(t)}):this.inside.inputText.elems.push(t)}),$(e).find('input[type="tel"]').each((e,t)=>{this.inside.ignor.length>0?this.inside.ignor.forEach(e=>{e!==t&&this.inside.inputTel.elems.push(t)}):this.inside.inputTel.elems.push(t)}),$(e).find('input[type="email"]').each((e,t)=>{this.inside.ignor.length>0?this.inside.ignor.forEach(e=>{e!==t&&this.inside.inputEmail.elems.push(t)}):this.inside.inputEmail.elems.push(t)}),$(e).find("textarea").each((e,t)=>{this.inside.ignor.length>0?this.inside.ignor.forEach(e=>{e!==t&&this.inside.textarea.elems.push(t)}):this.inside.textarea.elems.push(t)}),$(e).find('input[type="submit"]').each((e,t)=>{this.inside.submit.elems.push(t)}),$(e).find('button[type="submit"]').each((e,t)=>{this.inside.submit.elems.push(t)}),this.inside.submit.elems.forEach(e=>{$(e).click(e=>{e.preventDefault(),this.check()})}),this._elemStatus=[],this.testMode=!1,this.check=()=>{function e(e){if(!(e.elems.length>0))return!0;for(let t=0;t<e.elems.length;t++){let i=e.elems[t];if($(i).attr("required")){if(""===i.value){_this._elemStatus.push({elem:i,status:"incorrect"}),$(i).addClass("_incorrect");continue}}else if(""===i.value){_this._elemStatus.push({elem:i,status:"correct"}),$(i).removeClass("_incorrect");continue}if(null!=e.valueLength){if(!(i.value.length<=e.valueLength)){_this._elemStatus.push({elem:i,status:"incorrect"}),$(i).addClass("_incorrect");continue}_this._elemStatus.push({elem:i,status:"correct"})}i.checkValidity()?e.valueCheckAlgorithm?e.valueCheckAlgorithm.test(i.value)?(_this._elemStatus.push({elem:i,status:"correct"}),$(i).removeClass("_incorrect")):(_this._elemStatus.push({elem:i,status:"incorrect"}),$(i).addClass("_incorrect")):(_this._elemStatus.push({elem:i,status:"correct"}),$(i).removeClass("_incorrect")):(_this._elemStatus.push({elem:i,status:"incorrect"}),$(i).addClass("_incorrect"))}}this._elemStatus.length=0,_this=this,e(this.inside.inputText),e(this.inside.inputTel),e(this.inside.inputEmail),e(this.inside.textarea),this.inside.acceptance.elems.length>0&&this.inside.acceptance.elems.forEach(e=>{$(e).is(":checked")?this._elemStatus.push({elem:e,status:"correct"}):this._elemStatus.push({elem:e,status:"incorrect"})});for(let e=0;e<this._elemStatus.length;e++){if("incorrect"===this._elemStatus[e].status){this.testMode&&($(this.inside.form).removeClass("test_STATUS-CORRECT"),$(this.inside.form).addClass("test_STATUS-INCORRECT")),this.inside.form.dispatchEvent(n);break}e+1===this._elemStatus.length&&(this.testMode?($(this.inside.form).removeClass("test_STATUS-INCORRECT"),$(this.inside.form).addClass("test_STATUS-CORRECT")):this.inside.form.dispatchEvent(i))}},Object.defineProperty(this,"_elemStatus",{writable:!1,configurable:!1})}catch(e){console.log(e)}};$(document).ready(()=>{if($(".header-callback .header-callback-form").length>0)new FormValidation($(".header-callback .header-callback-form")[0],{inputText:{valueLength:254},inputTel:{valueCheckAlgorithm:/^(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)?$/,valueLength:50},inputEmail:{valueCheckAlgorithm:/^([a-z0-9_-]+\.)*[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/,valueLength:254},acceptance:$(".header-callback .header-callback-form-policy__input")[0]});if($(".header-callback-vacancy .header-callback-form").length>0)new FormValidation($(".header-callback-vacancy .header-callback-form")[0],{inputText:{valueLength:254},inputTel:{valueCheckAlgorithm:/^(\s*)?(\+)?([- _():=+]?\d[- _():=+]?){10,14}(\s*)?$/,valueLength:50},inputEmail:{valueCheckAlgorithm:/^([a-z0-9_-]+\.)*[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/,valueLength:254},acceptance:$(".header-callback-vacancy .header-callback-form-policy__input")[0],ignor:$(".header-callback__vacancy")[0]})});
function isMobile(){return!!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)}$(document).ready((function(){if($(".aside-nav").length>0){var e,t={init:!1,direction:"horizontal",loop:!1,spaceBetween:30,slidesPerView:"auto"},i=new Swiper(".aside-nav",t);function n(){window.innerWidth>850?"large"!==e&&(e="large",i.destroy(),_asudeNav=null):"small"!==e&&(e="small",(i=new Swiper(".aside-nav",t)).init())}i.init(),n(),$(window).resize(n)}})),$(document).ready((function(){const e=document.querySelectorAll('a[href^="#"].aside-nav-list__link');for(let t of e)t.addEventListener("click",(function(e){e.preventDefault();const i=t.getAttribute("href");document.querySelector('a[href^="#"].aside-nav-list__link._current').classList.remove("_current"),t.classList.add("_current"),document.querySelector(i).scrollIntoView({behavior:"smooth",block:"start"})}));if(!$("body").hasClass("page-home")&&$(".aside").length>0){var t=$('.aside-nav-list__link[href^="#"]'),i=$(".main"),n=($(".content-wrapper"),[]);function r(e){n.forEach(t=>{t.value===e?$(t.elem).addClass("_current"):$(t.elem).removeClass("_current")})}t.each((e,t)=>n.push({elem:t,value:$(t).attr("href").replace(/#/,"")})),$(t[0]).addClass("_current"),i.on("scroll",(function(){let e=i[0].offsetWidth-i[0].clientWidth,t=document.elementFromPoint(window.screen.width-(e+parseInt($($("main section")[0]).css("padding-right"))+10),window.screen.height/2);$("body").hasClass("page-projects")?$(t).is("li[id]")?r($(t).attr("id")):$(t).parents("li[id]").length>0&&r($(t).parents("li[id]").attr("id")):$(t).is("section[id]")?r($(t).attr("id")):$(t).parents("section[id]").length>0&&r($(t).parents("section[id]").attr("id"))}))}}));
>>>>>>> 10d469525a2212e336b9a946e1bc2e78f798fecb
